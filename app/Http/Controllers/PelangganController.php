...
class PelangganController extends Controller
{
    ...
    {
        $pelanggans = Pelanggan::with(['golongan', 'users'])->get();
    ...
    public function create()
    {
        ...
        $users = Users::where('user_aktif', 'Y')->get();
    ...
    {
        $pelanggan = Pelanggan::with('users')->findOrFail($id); // Memastikan relasi dengan users dimuat
        $golongans = Golongan::all();
        $users = Users::where('user_aktif', 'Y')->get();
